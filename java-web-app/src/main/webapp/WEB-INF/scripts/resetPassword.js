...
show_password.addEventListener('click', () => {
  ...
  show_password.src = show_password.src.includes('open') ? '../resources/public/icons/eye-close.png' : '../resources/public/icons/eye-open.png'
})

show_confirmPassword.addEventListener('click', () => {
  confirmPasswordInput.type = confirmPasswordInput.type === 'password' ? 'text' : 'password'

  show_confirmPassword.src = show_confirmPassword.src.includes('open') ? '../resources/public/icons/eye-close.png' : '../resources/public/icons/eye-open.png'
})
